#
#  Be sure to run `pod spec lint CCZoomTransition.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "CCZoomTransition", "Classes/*.{swift}"
